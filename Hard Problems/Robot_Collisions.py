...
class Solution(object):
    def survivedRobotsHealths(self, positions, healths, directions):
        ...
        robots.sort()  # Sort robots by their positions.
        ...
        for pos, health, dir in robots:
            if dir == 'R':
                ...
                while stack and stack[-1][2] == 'R' and health > 0:
                    prev_pos, prev_health, prev_dir = stack.pop()
                    if prev_health > health:
                        prev_health -= 1
                        stack.append((prev_pos, prev_health, prev_dir))
                        health = 0
        ...
        # Extract the remaining healths in the original order.
        survivors = {pos: health for pos, health, dir in stack}
        result = [survivors.get(pos, 0) for pos in positions]
