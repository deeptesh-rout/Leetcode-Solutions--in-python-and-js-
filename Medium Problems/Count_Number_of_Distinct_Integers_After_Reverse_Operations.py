...
The reversed integers that were added to the end of the array are underlined. Note that for the integer 10, after reversing it, 
it becomes 01 which is just 1.
...
class Solution(object):
    def countDistinctIntegers(self, nums):
        ...
        for num in nums:
            reversed_nums = int(str(num)[::-1])
            distinct_nums.add(reversed_nums)
